<?php
	...
	$pdf_output = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
		...
		<body xml:lang="en">
			<bookmark content="'.htmlentities(get_bloginfo('name'), ENT_QUOTES).'" level="0" /><tocentry content="'.htmlentities(get_bloginfo('name'), ENT_QUOTES).'" level="0" />
			...
			while (have_posts()) : the_post();
				...
				<h2>test<a href="' . get_permalink() . '" rel="bookmark" title="Permanent Link to ' . the_title('','', false) . '">' . the_title('','', false) . '</a></h2>';
